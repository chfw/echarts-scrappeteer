...
program
  .arguments('<url/file>')
  .option('-f, --format <png,jpeg,gif,svg>', 'image format')
...
function main(url_or_file, program){
  ...
  if (final_options.imageFormat != 'png' && final_options.imageFormat != 'jpeg' && final_options.imageFormat != 'gif' && final_options.imageFormat != 'svg'){
